...
namespace BibliotecaAPI.Controllers.V1
{
    ...
    public class AutoresController : ControllerBase
    {
        ...
        [EndpointDescription("Obtiene autor por id. Incluye sus kibros. Si el autor no existe, se retorna 404")]
        ...
        [HttpGet("filtrar" , Name = "FiltarAutoresV1")]
        [AllowAnonymous]
        public async Task<ActionResult> Filtrar([FromQuery] AutorFiltroDTO autorFiltroDTO)
        {
            ...
            if (!string.IsNullOrEmpty(autorFiltroDTO.TituloLibro))
            {
                queryable = queryable.Where
                    (x => x.Libros.Any(y => y.Libro!.Titulo.Contains(autorFiltroDTO.TituloLibro)));
            }
