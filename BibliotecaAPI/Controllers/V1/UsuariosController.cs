...
namespace BibliotecaAPI.Controllers.V1
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        [HttpPost("login", Name = "LogearUsuarioV1")]
        ...
        [HttpGet("renovarToken" , Name = "RenovarTokenUsuarioV1")]
        [Authorize]
        ...
        [HttpPost("hacer_admin" , Name = "HacerAdminUsuarioV1")]
        //[Authorize(Policy = "esadmin")]
        ...
        [HttpPost("remover_admin", Name = "RemoverAdminUsuarioV1")]
        [Authorize(Policy = "esadmin")]
