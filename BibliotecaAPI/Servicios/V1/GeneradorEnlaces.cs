    ...
    public class GeneradorEnlaces : IGeneradorEnlaces
    {
        ...
        public async Task<ColeccionDeRecursosDTO<AutorDTO>> GenerarEnlaces(List<AutorDTO> autores)
        {
            ...
            foreach (var dto in autores)
            {
                ...
                resultado.Enlaces.Add(new DatosHATEOASDTO(Enlace: linkGenerator.GetUriByRouteValues(httpContextAccessor.HttpContext!,
        ...
        {
            autorDTO.Enlaces.Add(new DatosHATEOASDTO(Enlace: linkGenerator.GetUriByRouteValues(httpContextAccessor.HttpContext!,
            ...
            if (esAdmin)
            {
                ...
                autorDTO.Enlaces.Add(new DatosHATEOASDTO(Enlace: linkGenerator.GetUriByRouteValues(httpContextAccessor.HttpContext!,
                  ...
                  Descripcion: "actor-patch", Metodo: "PATCH"));
                autorDTO.Enlaces.Add(new DatosHATEOASDTO(Enlace: linkGenerator.GetUriByRouteValues(httpContextAccessor.HttpContext!,
                       "BorrarAutorV1", new { id = autorDTO.Id })!,
                  Descripcion: "actor-borrar", Metodo: "DELETE"));
            }
        }
    }
}
