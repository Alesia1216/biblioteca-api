...
namespace BibliotecaAPITest.PruebasUnitarias.Controllers.V1
{
    ...
    public class AutoresControllerPruebas : BasePruebas
    {
        ...
        public async Task Put_ActualizaAutor_CuandoEnviamosAutorSinFoto()
        {
            ...
            Assert.AreEqual(expected: "Alesia2", actual: autorActualizado.Nombres);
            Assert.AreEqual(expected: "Sera2", actual: autorActualizado.Apellidos);
        ...
        public async Task Patch_ActualizaUnCampo_CuandoSeLeEnviaUnaOperacion()
        {
            ...
            var patchDoc = new JsonPatchDocument<AutorPatchDTO>();
            patchDoc.Operations.Add(new Operation<AutorPatchDTO>("replace", "/nombres", null, "Alesia2"));
            ...
            Assert.AreEqual(expected: "Alesia2", autorBD.Nombres);
            Assert.AreEqual(expected: "Sera", autorBD.Apellidos);
